...
final loadRegisterData = LoadRegisterData(registerRepository);
  @override
  void dispose() {
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        BlocProvider.of<RegisterBloc>(context).add(RegisterSubmitted(registerModel));
