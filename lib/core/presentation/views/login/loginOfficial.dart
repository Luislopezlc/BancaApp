...
class _LoginPageState extends State<LoginPage> {
        ...
        showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: const Text('La autentificación ha fallado. Intentar de nuevo.'),
              actions: [
                TextButton(
  ...
  decoration: InputDecoration(
    ...
    labelStyle: const TextStyle(
      ...
      fontSize: 12.0, // Tamaño de la fuente de la etiqueta
      fontWeight: FontWeight.bold, // Peso de la fuente de la etiqueta
    ),
