      ...
      children: [
              ...
              children: [
                ...
                ButtonOption(
                  ...
                  onPressed: () {
                    // Acción para los movimientos
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Withdrawals()));
                  },
                ),
                ...
                ButtonOption(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => ServicePay()));
                  },
                ),
              ],
            ),
        ...
        GestureDetector(
          onTap: () {
            ...
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => Movements()));
          },
          child: Padding(
            padding: EdgeInsets.all(10),
            child: Container(
